 ...
 * Table tl_article
 */
$GLOBALS['TL_DCA']['tl_news']['fields']['lazyDisable'] = array
(
...
// Subpalettes
$GLOBALS['TL_DCA']['tl_news']['subpalettes']['addImage'] = str_replace(',floating', ',floating,lazyDisable', $GLOBALS['TL_DCA']['tl_news']['subpalettes']['addImage']);
