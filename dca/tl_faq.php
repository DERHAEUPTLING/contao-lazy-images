 ...
 * Table tl_article
 */
$GLOBALS['TL_DCA']['tl_faq']['fields']['lazyDisable'] = array
(
...
// Subpalettes
$GLOBALS['TL_DCA']['tl_faq']['subpalettes']['addImage'] = str_replace(',floating', ',floating,lazyDisable', $GLOBALS['TL_DCA']['tl_faq']['subpalettes']['addImage']);
